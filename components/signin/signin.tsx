        ...
        <div className="flex-1 flex items-center justify-center px-8 md:px-16">
          <div className="w-full max-w-md">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 border border-[#006E74]/20 py-2.5 rounded-xl text-sm font-medium hover:bg-[#006E74]/5 transition-colors text-[#6B5E5E] mb-8"
            >
            ...
            <div className="relative flex items-center justify-center mb-8">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-[#006E74]/10" />
              </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-[#6B5E5E]/40 hover:text-[#F35D2C]"
                  >
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 text-sm text-[#6B5E5E]/80 cursor-pointer">
                  <input
                    type="checkbox"
                ...
                <Link
                  ...
                  className="text-sm text-[#006E74] hover:text-[#F35D2C] transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#F35D2C] hover:bg-opacity-90 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3.5 rounded-2xl transition-all shadow-md active:scale-[0.99] mt-2"
              >
            ...
            <p className="text-center text-sm text-[#6B5E5E]/70 mt-8">
              ...
              <Link href="/signup" className="text-[#F35D2C] font-semibold hover:underline">
                Sign Up
              </Link>
            </p>
          </div>
