export function getPageInstructions(pageId: string, originalLink: string, productTitle: string, videoTitle: string = ''): string {
  const instructions: Record<string, string> = {
    ...
    'bridge-ad': `
YOU ARE BUILDING: A Russell Brunson‑style Bridge Page
TONE: Like you’re sitting across from a friend at Starbucks, telling them the one thing that changed your life. Warm. Real. Conversational.

THIS PAGE HAS ONE JOB: Make them curious enough to click the button. NO HARD SELLING. The sale happens on the next page.

EXACT BLOCK ORDER – DO NOT MESS WITH THIS:
1. "attention-bar" – one line, a hook that hints at the transformation. Don’t name the product yet.
2. "article" – variant per personality. Author = a real first name. eyebrow = "MY HONEST STORY".
3. "image" 21/9 – a lifestyle image that sets the mood. No product shots yet.
4. "dropcap-paragraph" – start with "I". Tell them the exact problem you had before you found this solution. 3‑4 sentences, plain text. Make it feel like a text message from a friend.
5. "paragraph" – HTML with <h2> sections:
   <h2>The Problem I Could Not Fix</h2> – paint the pain so real they feel it in their gut.
   <h2>What I Tried Before (And Why It Failed)</h2> – list 2‑3 attempts that didn’t work. Be specific about why they failed. This builds empathy.
   <h2>Then Everything Changed</h2> – the moment you discovered the solution. Not a sales pitch – a story beat.
6. "pull-quote" – one sentence, past tense, first person. The exact moment of realisation.
7. "paragraph" – continue the story:
   <h2>What Happened Next Shocked Me</h2> – the results. Numbers, timeframes, specifics.
   <h2>Why I Am Sharing This</h2> – your real reason for recommending. Must feel genuine, not scripted.
8. "callout" – headline: "The One Thing That Made The Difference". Body: a bridge sentence that connects the story to the product without naming it directly.
9. "testimonial" – a real‑sounding person with the same problem who got the same result.
10. "button" – CTA: "Watch This Free Presentation" or "See What Changed Everything". ctaLink: "#"
11. "badge" – trust signals: no spam, free access, takes 2 minutes.

RULES FROM RUSSELL:
- NEVER name the product until the CTA button. Let the story create desire first.
- The dropcap paragraph should read like you wrote it at 2am after a breakthrough.
- The "What I Tried Before" section must directly acknowledge the visitor’s skepticism.
- CTA button text: NEVER "Buy Now" or "Order". This page only gets them to the next step.`,
...
10. "subheading" – the "No thanks" line: "No thanks, I do not want [specific thing the upgrade provides]. Please process my original order only." – style it as plain text link.
...
RUSSELL’S RULE: "${originalLink}" is on the main CTA button ONLY.`,
    ...
    // ── Legacy page instructions (backward compat) – no duplicates ──────────
...
Final button ctaLink: "#"`,
    ...
    bridge: `Same as bridge‑ad – personal story bridge page with dropcap‑paragraph opening.
Final button ctaLink: "#"`,
